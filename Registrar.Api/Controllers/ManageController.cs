...
namespace Registrar.Api.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public ManageController(RegiUserManager userManager, RegiSignInManager signInManager)
        {
        ...
        {
            get { return _signInManager ?? HttpContext.GetOwinContext().Get<RegiSignInManager>(); }
            private set { _signInManager = value; }
        }

        public RegiUserManager UserManager
        {
            get { return _userManager ?? HttpContext.GetOwinContext().GetUserManager<RegiUserManager>(); }
        ...
        public async Task<ActionResult> RemoveLogin(string loginProvider, string providerKey)
        {
            ...
            var result =
                await
                    UserManager.RemoveLoginAsync(Convert.ToInt32(User.Identity.GetUserId()),
