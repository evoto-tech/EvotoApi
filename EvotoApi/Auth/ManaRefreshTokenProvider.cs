...
{
    public class ManaRefreshTokenProvider : AuthenticationTokenProvider
    {
        private readonly IManaRefreshTokenStore _store;

        public ManaRefreshTokenProvider()
        {
            _store = (IManaRefreshTokenStore) DependencyResolver.Current.GetService(typeof(IManaRefreshTokenStore));
        }
